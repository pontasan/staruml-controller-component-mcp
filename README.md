...
5. All Component Diagram tools become available via MCP
...
```bash
claude mcp add staruml-component -e STARUML_PASSWORD=<password> -- node /absolute/path/to/staruml-controller-component-mcp/dist/index.js
```
